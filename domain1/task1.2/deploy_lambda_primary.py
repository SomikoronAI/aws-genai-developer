...
"""
Creates or updates the primary Lambda function used by the AI assistant.
...
environment_variables = {
    ...
    "APPCONFIG_APPLICATION": "AIAssistantApp",
    "APPCONFIG_ENVIRONMENT": "prod",
    "APPCONFIG_CONFIGURATION": "ModelSelectionStrategy"
}

base_dir = os.path.dirname(os.path.abspath("__file__"))
zip_path = os.path.join(base_dir, "lambda_package", "primary_model", "primary_lambda.zip")
