...
"""
Provision and maintain the TextReview AWS Lambda function.
...
Usage:
python deploy_lambda_textreview.py
"""
...
zip_path = os.path.join(base_dir, "lambda_packages", "text_review", "textreview_lambda.zip")
