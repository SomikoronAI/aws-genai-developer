# Assignment Part 1
"""Creates S3 trigger to TextValidation lambda"""
...
prefix_name = "domain1/task3/raw_data/reviews/"
# Lambda name
...
def allow_s3_invoke_lambda(lambda_client, lambda_function_name: str):
    ...
    #     StatementId=f"AllowS3Invoke{lambda_function_name}-{uuid.uuid4()}",
...
# --------------------------------------
# Add trigger to the S3 bucket
# --------------------------------------
def config_type(lambda_arn: str, prefix_name: str, suffix_name: str):
    return {
