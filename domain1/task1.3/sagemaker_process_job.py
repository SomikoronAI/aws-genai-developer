...
def process_survey_data(input_path, output_path):
    ...
    print("Cloumn name of the dataframe: ", df.columns.tolist())
    ...
    with open(f"{output_path}/survey_summaries.jsonl", 'w') as f:
        json.dump(summaries, f)
    
    with open(f"{output_path}/survey_statistics.jsonl", 'w') as f:
