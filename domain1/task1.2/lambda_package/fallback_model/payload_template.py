...
such as the 'messages' API (Claude 3/4), legacy text-completion API (Claude v2), 
Nova, Titan, Meta, and Mistral.
...
class PayloadTemplateManager:
    ...
    def get_payload_titan(
        ...
        """ Build a payload for invoking Amazon Titan text models using invoke_model."""
    ...
    def get_payload_llama(
        self,
        user_prompt: str,
        temperature: float = 0.2,
        max_tokens: int = 512
        ) -> Dict[str, Any]:
        """ Build a payload for invoking Meta Llama models using invoke_model."""
    ...
    def get_payload_mistral(
        ...
        """ Build a payload for invoking Mistral Mistral-small models using invoke_model."""
