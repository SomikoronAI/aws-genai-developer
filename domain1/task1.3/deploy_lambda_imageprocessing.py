...
"""
Provision and maintain the TextExtract AWS Lambda function.
...
Usage:
python deploy_lambda_imageprocessing.py
"""
...
lambda_function_name = "ImageProcessing"
...
zip_path = os.path.join(base_dir, "lambda_packages", "image_processing", "imageprocessing_lambda.zip")
