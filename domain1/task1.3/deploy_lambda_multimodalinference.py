...
"""
Provision and maintain the MultiModalInference AWS Lambda function.
...
Usage:
python deploy_lambda_multimodalinference.py
"""
...
zip_path = os.path.join(base_dir, "lambda_packages", "multimodal_inference", "multimodal_inference_lambda.zip")
