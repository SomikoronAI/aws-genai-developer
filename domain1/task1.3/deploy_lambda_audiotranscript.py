...
"""
Provision and maintain the AudioTranscript AWS Lambda function.
...
Usage:
python deploy_lambda_audiotranscript.py
"""
...
zip_path = os.path.join(base_dir, "lambda_packages", "audio_transcript", "audiotranscript_lambda.zip")
